...
const cards = [
  ...
  { icon:<Code2 size={21} />,     title:"API Architect",   desc:"RESTful APIs for SaaS, POS, and e-commerce platforms.",              color:"#c47d45", bg:"rgba(196,125,69,0.14)" },
  { icon:<Database size={21} />,  title:"Database Design", desc:"MySQL schema design, query optimisation, and data integrity.",        color:"#a96f45", bg:"rgba(169,111,69,0.14)" },
  { icon:<GitBranch size={21} />, title:"Clean Code",      desc:"Git workflows, CI/CD pipelines, and maintainable codebases.",        color:"#e6bd82", bg:"rgba(230,189,130,0.14)" },
];
        ...
        <div className="grid lg:grid-cols-5 gap-5 sm:gap-7 md:gap-8 items-start">
          ...
          <motion.div className="lg:col-span-3"
            ...
            <div className="p-5 sm:p-8 space-y-5 h-full relative overflow-hidden rounded-[1.35rem]"
              ...
              <p className="leading-relaxed text-sm sm:text-[15px]" style={{ color:"rgba(222,228,236,0.76)" }}>
              ...
              <p className="leading-relaxed text-sm sm:text-[15px]" style={{ color:"rgba(222,228,236,0.76)" }}>
                ...
                <span style={{ color:"#e6bd82", fontWeight:600 }}>Vue.js</span> to become a more complete
              ...
              <div className="pt-3 grid grid-cols-3 gap-2 sm:gap-4 border-t border-white/10">
                {[
                  ...
                  <motion.div key={label}
                    ...
                    <div className="text-xl sm:text-2xl font-bold" style={{ color:["#d49a57","#c47d45","#e6bd82"][i] }}>{val}</div>
